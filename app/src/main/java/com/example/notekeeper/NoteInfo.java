...
public final class NoteInfo implements Parcelable {
    ...
    // Parcels should be read in order of original class declaration. Parcels have no way to identify the actual object structure.
    ...
    // Writes Object members to the Parcel
    @Override
    ...
    // Allows a Parcel to be re-creatable. CREATOR will create instances of NoteInfo class.
